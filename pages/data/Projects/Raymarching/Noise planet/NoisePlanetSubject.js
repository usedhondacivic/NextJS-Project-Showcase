...
const NoisePlanetSubject = (scene) => {
    const vertexShader = `
    void main()
    {
...
void main()
{
    ...
    if (dist > MAX_DIST - EPSILON) {
        ...
        gl_FragColor = vec4(glowTop / glowFactor + 255.0, glowTop / glowFactor + 255.0, glowTop / glowFactor + 255.0, 1.0);
		return;
    }
    ...
    function onWindowResize(width, height){
        shaderUniforms.iResolution.value.x = width;
        shaderUniforms.iResolution.value.y = height;
    }
...
export default NoisePlanetSubject;